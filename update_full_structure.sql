-- Gerado em: 2026-04-29 07:52:07
-- DEV:  127.0.0.1/base_dev
-- PROD: 100.72.176.93/base

SET TERM ^ ;

ALTER TABLE "LOJA" ADD "BAIRRO" VARCHAR(100) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "CEP" VARCHAR(20) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "CIDADE" VARCHAR(100) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "COMPLEMENTO" VARCHAR(100) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "GOOGLE_ANALYTICS_ID" VARCHAR(50) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "INSTA" VARCHAR(1000) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "META_PIXEL_ID" VARCHAR(50) CHARACTER SET UTF8 ^

ALTER TABLE "LOJA" ADD "NUMERO" VARCHAR(20) CHARACTER SET UTF8 DEFAULT 'S/N' ^

ALTER TABLE "LOJA" ADD "UF" VARCHAR(2) CHARACTER SET UTF8 ^
